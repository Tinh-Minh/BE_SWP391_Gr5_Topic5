...
public class GlassesDesign {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "lens_id", nullable = true)
    private Lens lens;

    @Column(name = "frame_color",    length = 100) private String frameColor;
    @Column(name = "frame_size",     length = 50)  private String frameSize;
