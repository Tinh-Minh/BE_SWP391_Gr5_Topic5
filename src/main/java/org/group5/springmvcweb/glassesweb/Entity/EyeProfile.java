...
public class EyeProfile {
    ...
    // Tên hồ sơ do customer tự đặt — VD: "Đơn thuốc tháng 6", "Mắt cận nặng"
    @Column(name = "profile_name", length = 255)
    private String profileName;

    @Column(name = "source", length = 50)
    @Enumerated(EnumType.STRING)
    private EyeProfileSource source; // MANUAL, UPLOADED
    ...
    @Enumerated(EnumType.STRING)
    private EyeProfileStatus status; // ACTIVE, INACTIVE
    ...
    public enum EyeProfileSource {
        MANUAL, UPLOADED
    }

    public enum EyeProfileStatus {
        ACTIVE, INACTIVE
    }
}