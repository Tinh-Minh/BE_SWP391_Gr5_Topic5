...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/operation/**").hasAnyAuthority("ADMIN", "OPERATION")
                        .requestMatchers("/shipper/**").hasAnyAuthority("ADMIN", "SHIPPER")
                        .requestMatchers("/inventory/**").hasAnyAuthority("ADMIN", "STAFF")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(
                ...
                "http://localhost:3000" ,
                "https://glassesweb-fe-tgmv.onrender.com" // CRA default
        ));
