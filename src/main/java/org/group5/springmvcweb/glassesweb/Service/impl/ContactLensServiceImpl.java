...
public class ContactLensServiceImpl implements ContactLensService {
    ...
    public ContactLens updateContactLens(Integer id, UpdateContactLensRequest request) {
        ...
        if (request.getBrand() != null) contactLens.setBrand(request.getBrand());
    ...
    public void deleteContactLens(Integer id) {
        if (!repo.existsById(id))
            throw new RuntimeException("ContactLens khong ton tai!");
        try {
            repo.deleteById(id);
        } catch (Exception e) {
            throw new RuntimeException("Khong the xoa! San pham nay dang duoc su dung trong don hang hoac thiet ke.");
        }
    }
    ...
    private void ValidateContactLens(String name, String contactType, BigDecimal minSph,
        ...
        // contactType khong validate cung
