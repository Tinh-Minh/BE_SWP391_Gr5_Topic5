...
public class ReadyMadeGlassesServiceImpl implements ReadyMadeGlassesService {
    ...
    public void delete(Integer id) {
        ...
        ReadyMadeGlasses entity = readyMadeGlassesRepository.findById(id).orElseThrow(() -> new RuntimeException("ReadyMadeGlasses Not Found"));
        entity.setStatus("INACTIVE");
        if (entity.getStock() != null) entity.setStock(0);
        readyMadeGlassesRepository.save(entity);
    }
